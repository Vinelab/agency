...
use Agency\Office\Auth\Authorization\Exceptions\InvalidResourceTypeException;
...
class Access {
     ...
     *
     * @param  array of Agency\Office\Auth\Authorization\Entities\Privilege $privileges
     * @return array
     */
