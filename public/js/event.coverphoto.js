...
{
    cropped_cover_photo = JSON.stringify(getCroppedCoverPhoto());
    $("#cropped_cover_photo").val(cropped_cover_photo);
    $("#events_form").submit();
}

function removeCover(id, event_id)
{
    var obj = {id: id, event_id: event_id};
    $.ajax({
